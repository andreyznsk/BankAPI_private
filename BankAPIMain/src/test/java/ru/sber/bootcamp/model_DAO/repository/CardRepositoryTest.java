...
import ru.sber.bootcamp.model_DAO.repository.CardRepositoryImpl;
...
public class CardRepositoryTest {
    ...
    public void getCardByCardNumber() {
        Card card = new Card(1l,1111l,1111222233334441l, Date.valueOf("2023-01-01"),111);
        Card cardTest = dataConnectionService.getCardByCardNumber(1111222233334441l);
    ...
    public void getAllCardsByAccountNumber() {
        Card card = new Card(1l,1111l,1111222233334441l, Date.valueOf("2023-01-01"),111);
        List<Card> allCardByAccountNumber = dataConnectionService.getAllCardByAccountNumber(1111l);
    ...
    public void addCardByAccountNumber() {
        Card card = new Card();
        card.setAccountNumber(1111L);
        card.setCardNumber(1111111L);
    ...
    public void getCardWithMaxNumber() {
        Card card = new Card(null,null,1112222233334444l,null,0);
